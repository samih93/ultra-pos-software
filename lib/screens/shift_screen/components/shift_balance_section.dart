...
class ShiftBalanceSection extends ConsumerWidget {
  const ShiftBalanceSection({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    var futureTotals = ref.watch(futureReceiptTotalsByShiftProvider);
    return futureTotals.when(
      ...
      error: (error, stackTrace) => ErrorSection(
        retry: () => ref.refresh(futureReceiptTotalsByShiftProvider),
      ),
      loading: () {
        return Skeletonizer(
          child: SingleChildScrollView(
