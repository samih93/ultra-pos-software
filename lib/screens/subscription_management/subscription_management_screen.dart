...
import 'package:desktoppossystem/screens/subscription_management/components/subscription_card.dart';
import 'package:desktoppossystem/screens/subscription_management/components/subscription_summary_cards.dart';
import 'package:desktoppossystem/screens/subscription_management/subscription_management_screen_mobile.dart';
...
class SubscriptionManagementScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ResponsiveWidget(
      mobileView: const SubscriptionManagementScreenMobile(),
      desktopView: _buildDesktopView(context, ref),
    );
  }
  ...
  Widget _buildDesktopView(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      body: Column(
        children: [
          // Summary Cards
          SubscriptionSummaryCards(stats: state.stats),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: DebouncedTextFormField(
                    ...
                    hinttext: "search for subscriptions...",
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: LayoutBuilder(
                          builder: (context, constraints) {
                            // Calculate card width for 3 cards per row
                            ...
                            return Wrap(
                              ...
                              children: state.filteredSubscriptions.map((
                                subscription,
                              ) {
                                return SizedBox(
                                  width: cardWidth,
