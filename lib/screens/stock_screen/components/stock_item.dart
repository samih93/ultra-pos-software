    ...
    return InkWell(
        onTap: () async {
          if (stockItem.isActive == true) {
            await productAlertDialog(context, ref, stockItem,
                isFromStock: true);
          } else {
            showDialog(
                context: context,
        ...
        child: Container(
          ...
          child: Row(children: [
            ...
            Expanded(
                child: Text(stockItem.isTracked == true
                  ...
                  child: ElevatedButtonWidget(
                    ...
                    onPressed: () async {
                      await ref
                          ...
                          .openProductHistoryInExcel(productId: stockItem.id!);
                    },
                    text: null,
                  ),
                ),
                                        ...
                                        isloading
                                            ...
                                            : ElevatedButtonWidget(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  await printLabel(
                                                          index: index,
                                                          nbOfCopies: int.tryParse(
                                                                  nbOfCopiesController
                                                                      .text) ??
                                                              1,
                                                          context: context,
                                                          ref: ref)
